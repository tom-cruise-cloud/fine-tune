...
aws ec2 create-subnet --vpc-id <your-vpc-id> --cidr-block 10.0.1.0/24 --availability-zone us-east-1a --query Subnet.SubnetId --output text
aws ec2 create-subnet --vpc-id <your-vpc-id> --cidr-block 10.0.2.0/24 --availability-zone us-east-1b --query Subnet.SubnetId --output text
aws ec2 create-subnet --vpc-id <your-vpc-id> --cidr-block 10.0.3.0/24 --availability-zone us-east-1c --query Subnet.SubnetId --output text
