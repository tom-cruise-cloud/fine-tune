...
$vpcid =  
aws ec2 create-subnet --vpc-id $vpcid --cidr-block 10.0.1.0/24 --availability-zone us-east-1a --query Subnet.SubnetId --output text
...
curl -X POST -H "Content-Type: application/json" http://127.0.0.1:8080/invocations -d '{"role": "user", "content": "2 123456789010 eni-123 5b8ca123456789 172.31.9.69 172.31.9.12 49761 3389 6 20 4249 1418530010 1418530070 REJECT OK"}'
